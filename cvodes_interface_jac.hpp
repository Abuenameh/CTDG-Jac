...
/* 
 * File:   cvodes_interface_jac.hpp
 * Author: Abuenameh
 *
 * Created on December 26, 2015, 12:51 PM
 */

#ifndef CVODES_INTERFACE_JAC_HPP
#define CVODES_INTERFACE_JAC_HPP

#include <casadi/interfaces/sundials/casadi_integrator_cvodes_export.h>
#include <casadi/interfaces/sundials/sundials_interface.hpp>
...
namespace casadi {
  ...
  */
  class CASADI_INTEGRATOR_CVODES_EXPORT CvodesInterfaceJac : public SundialsInterface {
  public:
    /** \brief  Constructor */
    explicit CvodesInterfaceJac(const Function& f, const Function& g);

    /** \brief  Deep copy data members */
    virtual void deepCopyMembers(std::map<SharedObjectNode*, SharedObject>& already_copied);

    /** \brief  Clone */
    virtual CvodesInterfaceJac* clone() const;

    /** \brief  Create a new integrator */
    virtual CvodesInterfaceJac* create(const Function& f, const Function& g) const
    { return new CvodesInterfaceJac(f, g);}
...
#endif /* CVODES_INTERFACE_JAC_HPP */
