...
namespace casadi {
  ...
  int CASADI_INTEGRATOR_CVODES_EXPORT
    ...
    plugin->creator = CvodesInterfaceJac::creator;
    plugin->name = "cvodes";
    plugin->doc = CvodesInterfaceJac::meta_doc.c_str();;
    plugin->version = 23;
    return 0;
  }
  ...
  CvodesInterfaceJac* CvodesInterfaceJac::clone() const {
    // Return a deep copy
    CvodesInterfaceJac* node = new CvodesInterfaceJac(f_, g_);
    node->jac_ = jac_;
    node->linsol_ = linsol_;
    return node;
  }

  CvodesInterfaceJac::CvodesInterfaceJac(const Function& f, const Function& g) : SundialsInterface(f, g) {
  ...
  void CvodesInterfaceJac::freeCVodes() {
  ...
  CvodesInterfaceJac::~CvodesInterfaceJac() {
    freeCVodes();
  }

  void CvodesInterfaceJac::init() {
    log("CvodesInterfaceJac::init", "begin");
  ...
  void CvodesInterfaceJac::initAdj() {
  ...
  void CvodesInterfaceJac::rhs(double t, const double* x, double* xdot) {
    log("CvodesInterfaceJac::rhs", "begin");
    ...
    log("CvodesInterfaceJac::rhs", "end");

  }

  int CvodesInterfaceJac::rhs_wrapper(double t, N_Vector x, N_Vector xdot, void *user_data) {
    try {
      casadi_assert(user_data);
      CvodesInterfaceJac *this_ = static_cast<CvodesInterfaceJac*>(user_data);
  ...
  void CvodesInterfaceJac::reset() {
    casadi_msg("CvodesInterfaceJac::reset begin");
    ...
    casadi_msg("CvodesInterfaceJac::reset end");
  }

  void CvodesInterfaceJac::integrate(double t_out) {
    casadi_msg("CvodesInterfaceJac::integrate(" << t_out << ") begin");

    casadi_assert_message(t_out>=t0_,
                          "CvodesInterfaceJac::integrate(" << t_out << "): "
                          "Cannot integrate to a time earlier than t0 ("
                          << t0_ << ")");
    casadi_assert_message(t_out<=tf_ || !stop_at_end_, "CvodesInterfaceJac::integrate("
                          << t_out << "):"
    ...
    casadi_msg("CvodesInterfaceJac::integrate(" << t_out << ") end");
  }

  void CvodesInterfaceJac::resetB() {
    casadi_msg("CvodesInterfaceJac::resetB begin");
    ...
    casadi_msg("CvodesInterfaceJac::resetB end");
  }

  void CvodesInterfaceJac::integrateB(double t_out) {
    casadi_msg("CvodesInterfaceJac::integrateB(" << t_out << ") begin");
    int flag;
    ...
    casadi_msg("CvodesInterfaceJac::integrateB(" << t_out << ") end");
  }

  void CvodesInterfaceJac::printStats(std::ostream &stream) const {
    long nsteps, nfevals, nlinsetups, netfails;
    int qlast, qcur;
    double hinused, hlast, hcur, tcur;
    int flag = CVodeGetIntegratorStats(mem_, &nsteps, &nfevals, &nlinsetups, &netfails, &qlast,
  ...
  map<int, string> CvodesInterfaceJac::calc_flagmap() {
    map<int, string> f;
  ...
  map<int, string> CvodesInterfaceJac::flagmap = CvodesInterfaceJac::calc_flagmap();

  void CvodesInterfaceJac::cvodes_error(const string& module, int flag) {
    // Find the error
  ...
  void CvodesInterfaceJac::ehfun_wrapper(int error_code, const char *module, const char *function,
  ...
  void CvodesInterfaceJac::ehfun(int error_code, const char *module, const char *function, char *msg) {
    if (!disable_internal_warnings_) {
      userOut<true, PL_WARN>() << msg << endl;
    }
  }

  void CvodesInterfaceJac::rhsS(int Ns, double t, N_Vector x, N_Vector xdot, N_Vector *xF,
  ...
  int CvodesInterfaceJac::rhsS_wrapper(int Ns, double t, N_Vector x, N_Vector xdot, N_Vector *xF,
  ...
  void CvodesInterfaceJac::rhsS1(int Ns, double t, N_Vector x, N_Vector xdot, int iS, N_Vector xF,
                             N_Vector xdotF, N_Vector tmp1, N_Vector tmp2) {
    //    casadi_assert(Ns==nfdir_);
  ...
  int CvodesInterfaceJac::rhsS1_wrapper(int Ns, double t, N_Vector x, N_Vector xdot, int iS,
  ...
  int CvodesInterfaceJac::rhsQ_wrapper(double t, N_Vector x, N_Vector qdot, void *user_data) {
    try {
      casadi_assert(user_data);
      CvodesInterfaceJac *this_ = static_cast<CvodesInterfaceJac*>(user_data);
  ...
  void CvodesInterfaceJac::rhsQ(double t, const double* x, double* qdot) {
    // Pass input
    f_.setInputNZ(&t, DAE_T);
    f_.setInputNZ(x, DAE_X);
    f_.setInput(input(INTEGRATOR_P), DAE_P);
  ...
  void CvodesInterfaceJac::rhsQS(int Ns, double t, N_Vector x, N_Vector *xF, N_Vector qdot,
  ...
  int CvodesInterfaceJac::rhsQS_wrapper(int Ns, double t, N_Vector x, N_Vector *xF, N_Vector qdot,
  ...
  void CvodesInterfaceJac::rhsB(double t, const double* x, const double *rx, double* rxdot) {
    log("CvodesInterfaceJac::rhsB", "begin");
    ...
    log("CvodesInterfaceJac::rhsB", "end");
  }

  void CvodesInterfaceJac::rhsBS(double t, N_Vector x, N_Vector *xF, N_Vector rx, N_Vector rxdot) {
  ...
  int CvodesInterfaceJac::rhsB_wrapper(double t, N_Vector x, N_Vector rx, N_Vector rxdot,
                                   void *user_data) {
    try {
      casadi_assert(user_data);
      CvodesInterfaceJac *this_ = static_cast<CvodesInterfaceJac*>(user_data);
  ...
  int CvodesInterfaceJac::rhsBS_wrapper(double t, N_Vector x, N_Vector *xF, N_Vector xB,
  ...
  int CvodesInterfaceJac::rhsQB_wrapper(double t, N_Vector x, N_Vector rx,
  ...
  void CvodesInterfaceJac::rhsQB(double t, const double* x, const double* rx, double* rqdot) {
    if (monitor_rhsQB_) {
      userOut() << "CvodesInterfaceJac::rhsQB: begin" << endl;
    }
    ...
    if (monitor_rhsQB_) {
      userOut() << "CvodesInterfaceJac::rhsQB: end" << endl;
    }
  }

  int CvodesInterfaceJac::jtimes_wrapper(N_Vector v, N_Vector Jv, double t, N_Vector x,
  ...
  int CvodesInterfaceJac::jtimesB_wrapper(N_Vector vB, N_Vector JvB, double t, N_Vector x,
  ...
  void CvodesInterfaceJac::jtimes(N_Vector v, N_Vector Jv, double t, N_Vector x,
                              N_Vector xdot, N_Vector tmp) {
    log("CvodesInterfaceJac::jtimes", "begin");
    // Get time
    time1 = clock();
    ...
    log("CvodesInterfaceJac::jtimes", "end");
  }

  void CvodesInterfaceJac::jtimesB(N_Vector vB, N_Vector JvB, double t, N_Vector x, N_Vector xB,
                               N_Vector xdotB, N_Vector tmpB) {
    log("CvodesInterfaceJac::jtimesB", "begin");
    // Get time
    time1 = clock();
    ...
    time2 = clock();
    t_jac += static_cast<double>(time2-time1)/CLOCKS_PER_SEC;
    log("CvodesInterfaceJac::jtimesB", "end");
  }

  int CvodesInterfaceJac::djac_wrapper(long N, double t, N_Vector x, N_Vector xdot, DlsMat Jac,
  ...
  int CvodesInterfaceJac::djacB_wrapper(long NeqB, double t, N_Vector x, N_Vector xB, N_Vector xdotB,
  ...
  void CvodesInterfaceJac::djac(long N, double t, N_Vector x, N_Vector xdot, DlsMat Jac,
                            N_Vector tmp1, N_Vector tmp2, N_Vector tmp3) {
    log("CvodesInterfaceJac::djac", "begin");
    ...
    log("CvodesInterfaceJac::djac", "end");
  }

  void CvodesInterfaceJac::djacB(long NeqB, double t, N_Vector x, N_Vector xB, N_Vector xdotB,
                             DlsMat JacB, N_Vector tmp1B, N_Vector tmp2B, N_Vector tmp3B) {
    log("CvodesInterfaceJac::djacB", "begin");
    // Get time
    time1 = clock();
    ...
    time2 = clock();
    t_jac += static_cast<double>(time2-time1)/CLOCKS_PER_SEC;
    log("CvodesInterfaceJac::djacB", "end");
  }

  int CvodesInterfaceJac::bjac_wrapper(long N, long mupper, long mlower, double t, N_Vector x,
  ...
  int CvodesInterfaceJac::bjacB_wrapper(long NeqB, long mupperB, long mlowerB, double t, N_Vector x,
  ...
  void CvodesInterfaceJac::bjac(long N, long mupper, long mlower, double t, N_Vector x, N_Vector xdot,
                            DlsMat Jac, N_Vector tmp1, N_Vector tmp2, N_Vector tmp3) {
    log("CvodesInterfaceJac::bjac", "begin");
...
//    jac_.setInput(0.0, DAE_NUM_IN+1);
    ...
    log("CvodesInterfaceJac::bjac", "end");
  }

  void CvodesInterfaceJac::bjacB(long NeqB, long mupperB, long mlowerB, double t, N_Vector x,
                             N_Vector xB, N_Vector xdotB, DlsMat JacB, N_Vector tmp1B,
                             N_Vector tmp2B, N_Vector tmp3B) {
    log("CvodesInterfaceJac::bjacB", "begin");
    ...
    log("CvodesInterfaceJac::bjacB", "end");
  }

  void CvodesInterfaceJac::setStopTime(double tf) {
    // Set the stop time of the integration -- don't integrate past this point
    int flag = CVodeSetStopTime(mem_, tf);
    if (flag != CV_SUCCESS) cvodes_error("CVodeSetStopTime", flag);
  }

  int CvodesInterfaceJac::psolve_wrapper(double t, N_Vector x, N_Vector xdot, N_Vector r,
  ...
  int CvodesInterfaceJac::psolveB_wrapper(double t, N_Vector x, N_Vector xB, N_Vector xdotB,
  ...
  int CvodesInterfaceJac::psetup_wrapper(double t, N_Vector x, N_Vector xdot, booleantype jok,
  ...
  int CvodesInterfaceJac::psetupB_wrapper(double t, N_Vector x, N_Vector xB, N_Vector xdotB,
  ...
  void CvodesInterfaceJac::psolve(double t, N_Vector x, N_Vector xdot, N_Vector r, N_Vector z,
  ...
  void CvodesInterfaceJac::psolveB(double t, N_Vector x, N_Vector xB, N_Vector xdotB, N_Vector rvecB,
  ...
  void CvodesInterfaceJac::psetup(double t, N_Vector x, N_Vector xdot, booleantype jok,
                              booleantype *jcurPtr, double gamma, N_Vector tmp1,
                              N_Vector tmp2, N_Vector tmp3) {
    log("CvodesInterfaceJac::psetup", "begin");
    // Get time
    time1 = clock();
    ...
    log("CvodesInterfaceJac::psetup", "end");
  }

  void CvodesInterfaceJac::psetupB(double t, N_Vector x, N_Vector xB, N_Vector xdotB,
                               booleantype jokB, booleantype *jcurPtrB, double gammaB,
                               N_Vector tmp1B, N_Vector tmp2B, N_Vector tmp3B) {
    log("CvodesInterfaceJac::psetupB", "begin");
    // Get time
    time1 = clock();
    ...
    time1 = clock();
    t_lsetup_fac += static_cast<double>(time1-time2)/CLOCKS_PER_SEC;
    log("CvodesInterfaceJac::psetupB", "end");
  }

  void CvodesInterfaceJac::lsetup(CVodeMem cv_mem, int convfail, N_Vector x, N_Vector xdot,
                              booleantype *jcurPtr,
  ...
  void CvodesInterfaceJac::lsetupB(double t, double gamma, int convfail,
  ...
  int CvodesInterfaceJac::lsetup_wrapper(CVodeMem cv_mem, int convfail, N_Vector x, N_Vector xdot,
                                     booleantype *jcurPtr,
                                     N_Vector vtemp1, N_Vector vtemp2, N_Vector vtemp3) {
    try {
      CvodesInterfaceJac *this_ = static_cast<CvodesInterfaceJac*>(cv_mem->cv_lmem);
      casadi_assert(this_);
  ...
  int CvodesInterfaceJac::lsetupB_wrapper(CVodeMem cv_mem, int convfail, N_Vector x, N_Vector xdot,
                                      booleantype *jcurPtr,
                                      N_Vector vtemp1, N_Vector vtemp2, N_Vector vtemp3) {
    try {
      CvodesInterfaceJac *this_ = static_cast<CvodesInterfaceJac*>(cv_mem->cv_lmem);
  ...
  void CvodesInterfaceJac::lsolve(CVodeMem cv_mem, N_Vector b, N_Vector weight,
                              N_Vector x, N_Vector xdot) {
    log("CvodesInterfaceJac::lsolve", "begin");
    ...
    log("CvodesInterfaceJac::lsolve", "end");
  }

  void CvodesInterfaceJac::lsolveB(double t, double gamma, N_Vector b, N_Vector weight,
                               N_Vector x, N_Vector xB, N_Vector xdotB) {
    log("CvodesInterfaceJac::lsolveB", "begin");
    // Accuracy
    double delta = 0.0;
    ...
    log("CvodesInterfaceJac::lsolveB", "end");
  }

  int CvodesInterfaceJac::lsolve_wrapper(CVodeMem cv_mem, N_Vector b, N_Vector weight,
                                     N_Vector x, N_Vector xdot) {
    try {
      CvodesInterfaceJac *this_ = static_cast<CvodesInterfaceJac*>(cv_mem->cv_lmem);
      casadi_assert(this_);
  ...
  int CvodesInterfaceJac::lsolveB_wrapper(CVodeMem cv_mem, N_Vector b, N_Vector weight,
                                      N_Vector x, N_Vector xdot) {
    try {
      CvodesInterfaceJac *this_ = static_cast<CvodesInterfaceJac*>(cv_mem->cv_lmem);
      casadi_assert(this_);
  ...
  void CvodesInterfaceJac::initDenseLinearSolver() {
  ...
  void CvodesInterfaceJac::initBandedLinearSolver() {
  ...
  void CvodesInterfaceJac::initIterativeLinearSolver() {
    ...
    if (use_preconditioner_) {
      ...
      if (jac_.isNull())
          throw CasadiException("CvodesInterfaceJac::init(): No Jacobian has been provided.");

      // Make sure that a linear solver has been provided
      if (linsol_.isNull())
          throw CasadiException("CvodesInterfaceJac::init(): "
  ...
  void CvodesInterfaceJac::initUserDefinedLinearSolver() {
    // Make sure that a Jacobian has been provided
    if (jac_.isNull())
        throw CasadiException("CvodesInterfaceJac::initUserDefinedLinearSolver(): "
  ...
  void CvodesInterfaceJac::initDenseLinearSolverB() {
  ...
  void CvodesInterfaceJac::initBandedLinearSolverB() {
  ...
  void CvodesInterfaceJac::initIterativeLinearSolverB() {
    int flag;
    switch (itsol_g_) {
    case SD_GMRES:
    ...
    if (use_preconditionerB_) {
      // Make sure that a Jacobian has been provided
      if (jacB_.isNull())
        casadi_error("CvodesInterfaceJac::init(): No backwards Jacobian has been provided.");

      // Make sure that a linear solver has been provided
      if (linsolB_.isNull())
        casadi_error("CvodesInterfaceJac::init(): "
  ...
  void CvodesInterfaceJac::initUserDefinedLinearSolverB() {
    // Make sure that a Jacobian has been provided
    if (jacB_.isNull())
        throw CasadiException("CvodesInterfaceJac::initUserDefinedLinearSolverB(): "
  ...
  void CvodesInterfaceJac::deepCopyMembers(std::map<SharedObjectNode*, SharedObject>& already_copied) {
    SundialsInterface::deepCopyMembers(already_copied);
  }

  template<typename FunctionType>
  FunctionType CvodesInterfaceJac::getJacGen() {
  ...
  template<typename FunctionType>
  FunctionType CvodesInterfaceJac::getJacGenB() {
  ...
  Function CvodesInterfaceJac::getJacB() {
    if (is_a<SXFunction>(g_)) {
      return getJacGenB<SXFunction>();
    } else if (is_a<MXFunction>(g_)) {
      return getJacGenB<MXFunction>();
    } else {
      throw CasadiException("CvodesInterfaceJac::getJacB(): Not an SXFunction or MXFunction");
    }
  }


  Function CvodesInterfaceJac::getJac() {
      return getOption("full_jacobian");
    if (is_a<SXFunction>(f_)) {
      return getJacGen<SXFunction>();
    } else if (is_a<MXFunction>(f_)) {
      return getJacGen<MXFunction>();
    } else {
      throw CasadiException("CvodesInterfaceJac::getJac(): Not an SXFunction or MXFunction");
    }
  }
